...
public class DatawavePrincipalSecurityRealm implements SecurityRealm {
     ...
     * @param oscpLevel the oscp level to set, if the verifier is an instance of {@link DatawaveCertVerifier}
     */
     ...
     * @param trustedHeaderLogin the trusted header login
     */
     ...
     * @param jwtHeaderLogin the jwt header login
     */
     ...
     * @param disallowlistUserRole the disallowlist user role
     */
