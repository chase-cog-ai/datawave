 ...
 * <a href="https://java.net/jira/browse/WEBSOCKET_SPEC-238">WEBSOCKET_SPEC-238</a> for more details. Note: the previous link is outdated, but the issue was
 * reimported and is being worked on <a href="https://github.com/jakartaee/websocket/issues/238">here</a> for jakarta.
 * <p>
 ...
 * </pre>
 *
 * and also ensure that the server endpoint annotation sets {@link WebsocketSecurityConfigurator} as the {@link ServerEndpoint#configurator()} class.
 */
