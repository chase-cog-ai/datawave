...
public class ProxiedX509CertificateEvidenceIdentityProvider implements EvidenceIdentityProvider {
    ...
    public ProxiedX509CertificateEvidenceIdentityProvider(DatawaveUserService userService, SSLContextInfo sslContextInfo, X509CertificateVerifier certVerifier) throws IllegalArgumentException {
